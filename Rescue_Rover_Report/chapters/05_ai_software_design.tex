...
\begin{figure}[h!]
    ...
    \fbox{\parbox{\textwidth}{\centering\vspace{4cm}FIGURE: Host Application Architecture\\Block diagram showing FrameBuffer, Local YOLO Worker, Cloud Client, and Arbiter\vspace{4cm}}}
...
\begin{figure}[h!]
    \centering
    % \includegraphics[width=0.8\textwidth]{figures/software/cloud_architecture.png}
    \fbox{\parbox{0.8\textwidth}{\centering\vspace{3cm}FIGURE: Cloud Server Setup\\Diagram showing Colab notebook hosting vLLM and ngrok tunnel\vspace{3cm}}}
...
\begin{figure}[h!]
    \centering
    % \includegraphics[width=\textwidth]{figures/software/arbiter_logic.png}
    \fbox{\parbox{\textwidth}{\centering\vspace{3.5cm}FIGURE: Arbitration Logic Flow\\Flowchart showing Safety > Manual > AI priority logic\vspace{3.5cm}}}
