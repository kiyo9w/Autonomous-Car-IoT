...
\textbf{Note}: The HC-SR04 ECHO pin outputs 5V logic, which exceeds the ESP32-S3 GPIO maximum of 3.3V. Use the voltage divider shown above (R1=1kΩ, R2=2kΩ) or a bidirectional level shifter to avoid damaging the microcontroller.
